    ...
    <x-filament::section>
        ...
        <div style="font-family: 'Syne', ui-sans-serif, system-ui, sans-serif;">
            ...
            <div class="fw-card">
                ...
                {{-- Progress Track --}}
                <div class="fw-track">
                    <div class="fw-fill" style="width: {{ min($this->getTechnologiesCount() * 2, 100) }}%;"></div>
                </div>
                ...
                @if($this->getTechnologiesCount() > 0)
                    ...
                    @foreach($this->getRecentTechnologies() as $technology)
                        <div class="fw-item">
                            <div class="fw-item-left">
                                <div class="fw-dot"></div>
                                <span class="fw-item-name">{{ $technology->titre ?? $technology->name ?? __('Technology') }}</span>
                            </div>
                            <span class="fw-item-time">{{ $technology->created_at->diffForHumans() }}</span>
                        </div>
                    @endforeach
                @endif
